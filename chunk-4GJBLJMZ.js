...
var PlayerService = class _PlayerService {
  ...
  getAll(filters) {
    ...
    if (filters?.iplTeam)
      params = params.set("iplTeam", filters.iplTeam);
    if (filters?.role)
      params = params.set("role", filters.role);
    if (filters?.search)
      params = params.set("search", filters.search);
    if (filters?.isOverseas !== void 0)
      params = params.set("isOverseas", String(filters.isOverseas));
  ...
  uploadPlayers(rows) {
    return this.http.post(`${this.api}/players/upload`, rows);
  }
  uploadAuctionOrder(seasonId, rows) {
    return this.http.post(`${this.api}/players/auction-order/${seasonId}`, rows);
  }
  uploadDirectAllocation(seasonId, rows) {
    return this.http.post(`${this.api}/players/direct-allocation/${seasonId}`, rows);
  }
  static {
    this.\u0275fac = function PlayerService_Factory(t) {
      return new (t || _PlayerService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
...
function PlayersAdminComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function PlayersAdminComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PlayersAdminComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function PlayersAdminComponent_Conditional_18_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function PlayersAdminComponent_Conditional_19_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function PlayersAdminComponent_Conditional_19_Conditional_2_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 16);
    \u0275\u0275listener("click", function PlayersAdminComponent_Conditional_19_Conditional_2_For_2_Template_button_click_0_listener() {
      const s_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.selectSeason(s_r4));
    });
    \u0275\u0275elementStart(1, "div")(2, "span", 17);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function PlayersAdminComponent_Conditional_19_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275repeaterCreate(1, PlayersAdminComponent_Conditional_19_Conditional_2_For_2_Template, 8, 3, "button", 15, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PlayersAdminComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12);
    \u0275\u0275template(1, PlayersAdminComponent_Conditional_19_Conditional_1_Template, 2, 0, "p", 4)(2, PlayersAdminComponent_Conditional_19_Conditional_2_Template, 3, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(1, ctx_r0.loadingSeasons() ? 1 : 2);
  }
}
function PlayersAdminComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19)(1, "span", 17);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.selectedSeason().name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.modeLabel(ctx_r0.selectedSeason().mode));
  }
}
function PlayersAdminComponent_Conditional_21_For_22_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\u2726 ", rule_r5, "");
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Upload complete \u2014 locked for this season. ");
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Upload only once \u2014 re-upload requires starting over. ");
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 33);
    \u0275\u0275text(1, "\u{1F4C1}");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "span", 34);
    \u0275\u0275text(3, "Click to select Excel file");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 4);
    \u0275\u0275text(5, ".xlsx or .xls accepted");
    \u0275\u0275elementEnd();
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 35);
    \u0275\u0275listener("click", function PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.processUpload());
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.saving() ? "\u2699\uFE0F Processing..." : "\u2694\uFE0F Upload & Process", " ");
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 30);
    \u0275\u0275listener("click", function PlayersAdminComponent_Conditional_21_Conditional_33_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const fileInput_r7 = \u0275\u0275reference(2);
      return \u0275\u0275resetView(fileInput_r7.click());
    });
    \u0275\u0275elementStart(1, "input", 31, 0);
    \u0275\u0275listener("change", function PlayersAdminComponent_Conditional_21_Conditional_33_Template_input_change_1_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onFile($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_3_Template, 6, 1)(4, PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_4_Template, 6, 0);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, PlayersAdminComponent_Conditional_21_Conditional_33_Conditional_5_Template, 2, 2, "button", 32);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("has-file", ctx_r0.selectedFile());
    \u0275\u0275advance(3);
    \u0275\u0275conditional(3, ctx_r0.selectedFile() ? 3 : 4);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(5, ctx_r0.selectedFile() ? 5 : -1);
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_34_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "span", 40);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.uploadResult().skipped);
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_34_Conditional_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\u26A0\uFE0F ", e_r9, "");
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_34_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39);
    \u0275\u0275repeaterCreate(1, PlayersAdminComponent_Conditional_21_Conditional_34_Conditional_7_For_2_Template, 2, 1, "div", 41, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.uploadResult().errors);
  }
}
function PlayersAdminComponent_Conditional_21_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Imported");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, PlayersAdminComponent_Conditional_21_Conditional_34_Conditional_6_Template, 5, 1, "div", 37)(7, PlayersAdminComponent_Conditional_21_Conditional_34_Conditional_7_Template, 3, 0, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.uploadResult().imported);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(6, ctx_r0.uploadResult().skipped > 0 ? 6 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(7, ((tmp_4_0 = ctx_r0.uploadResult().errors) == null ? null : tmp_4_0.length) > 0 ? 7 : -1);
  }
}
function PlayersAdminComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "div", 8)(2, "div", 9);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "div", 10);
    \u0275\u0275text(6, "Download Template");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 4);
    \u0275\u0275text(8, "Template matches your season mode");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "div", 22)(10, "div", 23)(11, "span", 24);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div")(14, "div", 25);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 26);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "a", 27);
    \u0275\u0275text(19, " \u2B07\uFE0F Download ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 28);
    \u0275\u0275repeaterCreate(21, PlayersAdminComponent_Conditional_21_For_22_Template, 2, 1, "div", 29, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(23, "div", 21)(24, "div", 8)(25, "div", 9);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div")(28, "div", 10);
    \u0275\u0275text(29, "Upload File");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 4);
    \u0275\u0275template(31, PlayersAdminComponent_Conditional_21_Conditional_31_Template, 1, 0)(32, PlayersAdminComponent_Conditional_21_Conditional_32_Template, 1, 0);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(33, PlayersAdminComponent_Conditional_21_Conditional_33_Template, 6, 4)(34, PlayersAdminComponent_Conditional_21_Conditional_34_Template, 8, 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275classProp("done", ctx_r0.uploadDone());
    \u0275\u0275advance(2);
    \u0275\u0275classProp("complete", ctx_r0.uploadDone());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.uploadDone() ? "\u2705" : "2", " ");
    \u0275\u0275advance(7);
    \u0275\u0275property("ngClass", ctx_r0.templateStyle());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.templateIcon());
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.templateName());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.templateSheets());
    \u0275\u0275advance();
    \u0275\u0275property("href", ctx_r0.templateUrl(), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r0.templateRules());
    \u0275\u0275advance(4);
    \u0275\u0275classProp("complete", ctx_r0.uploadDone());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.uploadDone() ? "\u2705" : "3", " ");
    \u0275\u0275advance(5);
    \u0275\u0275conditional(31, ctx_r0.uploadDone() ? 31 : 32);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(33, !ctx_r0.uploadDone() ? 33 : 34);
  }
}
var PlayersAdminComponent = class _PlayersAdminComponent {
  constructor(seasonSvc, playerSvc, teamSvc) {
    this.seasonSvc = seasonSvc;
    this.playerSvc = playerSvc;
    this.teamSvc = teamSvc;
    this.seasons = signal([]);
    this.selectedSeason = signal(null);
    this.loadingSeasons = signal(true);
    this.saving = signal(false);
    this.uploadDone = signal(false);
  ...
  ngOnInit() {
    this.seasonSvc.getAll().subscribe({
      next: (d) => {
        this.seasons.set(d.filter((s) => s.status !== "Completed"));
  ...
  templateName() {
    ...
    return m === "FreshAuction" ? "Fresh Auction Template" : m === "AuctionWithRetentions" ? "Retention Auction Template" : "Direct Allocation Template";
  }
  templateIcon() {
    return { FreshAuction: "\u{1F3CF}", AuctionWithRetentions: "\u{1F504}", DirectAllocation: "\u{1F4CB}" }[this.selectedSeason()?.mode] ?? "\u{1F4C1}";
  }
  templateStyle() {
    return { FreshAuction: "fresh", AuctionWithRetentions: "retention", DirectAllocation: "direct" }[this.selectedSeason()?.mode] ?? "";
  }
  templateSheets() {
    return {
  ...
  modeLabel(m) {
    return {
      FreshAuction: "\u{1F7E2} Fresh",
      AuctionWithRetentions: "\u{1F7E1} Retention",
      DirectAllocation: "\u{1F535} Direct"
    }[m] ?? m;
  }
  processUpload() {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (season.mode === "DirectAllocation") {
          ...
          this.playerSvc.uploadDirectAllocation(season.id, rows).subscribe({
            next: (r) => {
            ...
            error: (e2) => {
              this.error.set(e2?.error?.error ?? "Upload failed.");
              this.saving.set(false);
            }
          });
        } else {
              ...
              this.playerSvc.uploadAuctionOrder(season.id, normalizedOrder).subscribe({
                next: (orderRes) => {
                  ...
                  if (season.mode === "AuctionWithRetentions" && wb.SheetNames[2]) {
                    ...
                    const retHeaderIndex = rawRet.findIndex((row) => row.includes("player_name \u2605") || row.includes("player_name"));
                    if (retHeaderIndex !== -1) {
                      ...
                      const normalizedRetention = retRows.map((r) => ({
                ...
                error: (e2) => {
                  this.error.set(e2?.error?.error ?? "Auction order upload failed.");
                  this.saving.set(false);
                }
              });
            },
            error: (e2) => {
              this.error.set(e2?.error?.error ?? "Player upload failed.");
              this.saving.set(false);
            }
          });
        }
  ...
  cleanKey(k) {
    return String(k).replace("\u2605", "").replace(/\uFEFF/g, "").trim().replace(/\s+/g, "_").toLowerCase();
  }
  sheetToRows(sheet, requiredKey) {
    const raw = utils.sheet_to_json(sheet, {
      header: 1,
      raw: false
    });
    const headerIndex = raw.findIndex((row) => row.some((x) => requiredKey.includes(this.cleanKey(x))));
    if (headerIndex === -1) {
      throw new Error(`Header not found ${requiredKey}`);
    }
    const headers = raw[headerIndex];
    return raw.slice(headerIndex + 1).filter((r) => r.some((x) => x !== void 0 && x !== "")).map((row) => {
      const obj = {};
      headers.forEach((h, i) => {
        obj[h] = row[i];
      });
  ...
  static {
    this.\u0275fac = function PlayersAdminComponent_Factory(t) {
      return new (t || _PlayersAdminComponent)(\u0275\u0275directiveInject(SeasonService), \u0275\u0275directiveInject(PlayerService), \u0275\u0275directiveInject(TeamService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PlayersAdminComponent, selectors: [["app-admin-players"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 22, vars: 10, consts: [["fileInput", ""], [1, "admin-page"], [1, "admin-page-header"], [1, "athena-page-title", 2, "margin-bottom", "4px"], [1, "athena-label"], [1, "athena-error", "animate-fade-in"], [1, "athena-success", "animate-fade-in"], [1, "wizard-step", "athena-card"], [1, "step-header"], [1, "step-num"], [1, "step-title"], [1, "athena-btn", "athena-btn-secondary", 2, "margin-left", "auto", "padding", "6px 12px", "font-size", "12px"], [2, "margin-top", "16px"], [1, "athena-btn", "athena-btn-secondary", 2, "margin-left", "auto", "padding", "6px 12px", "font-size", "12px", 3, "click"], [1, "season-select-list"], [1, "season-select-btn"], [1, "season-select-btn", 3, "click"], [1, "season-sel-name"], [1, "athena-badge", "athena-badge-surface", 2, "margin-left", "8px"], [1, "selected-season-display"], [1, "athena-badge", "athena-badge-gold"], [1, "wizard-step", "athena-card", "animate-fade-in"], [1, "template-info"], [1, "template-card", 3, "ngClass"], [1, "template-icon"], [1, "template-name"], [1, "template-sheets"], ["download", "", 1, "athena-btn", "athena-btn-primary", 2, "margin-left", "auto", "text-decoration", "none", "padding", "8px 16px", "font-size", "13px", 3, "href"], [1, "template-rules"], [1, "rule-row"], [1, "upload-area", 3, "click"], ["type", "file", "accept", ".xlsx,.xls", 2, "display", "none", 3, "change"], [1, "athena-btn", "athena-btn-primary", 2, "width", "100%", "margin-top", "12px", 3, "disabled"], [2, "font-size", "32px"], [1, "upload-filename"], [1, "athena-btn", "athena-btn-primary", 2, "width", "100%", "margin-top", "12px", 3, "click", "disabled"], [1, "upload-result-display"], [1, "result-stat"], [1, "result-num", 2, "color", "var(--green-cricket)"], [1, "result-errors"], [1, "result-num", 2, "color", "var(--gold)"], [1, "err-line"]], template: function PlayersAdminComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "div")(3, "h1", 3);
        \u0275\u0275text(4, "\u{1F3CF}\u{1F4E4} Player Upload");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "p", 4);
        \u0275\u0275text(6, "Select season \u2192 download template \u2192 upload data");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(7, PlayersAdminComponent_Conditional_7_Template, 2, 1, "div", 5)(8, PlayersAdminComponent_Conditional_8_Template, 2, 1, "div", 6);
        \u0275\u0275elementStart(9, "div", 7)(10, "div", 8)(11, "div", 9);
        \u0275\u0275text(12);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(13, "div")(14, "div", 10);
        \u0275\u0275text(15, "Select Season");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(16, "div", 4);
        \u0275\u0275text(17, "Choose which season to upload players for");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(18, PlayersAdminComponent_Conditional_18_Template, 2, 0, "button", 11);
        \u0275\u0275elementEnd();
        \u0275\u0275template(19, PlayersAdminComponent_Conditional_19_Template, 3, 1, "div", 12)(20, PlayersAdminComponent_Conditional_20_Template, 5, 2);
        \u0275\u0275elementEnd();
        \u0275\u0275template(21, PlayersAdminComponent_Conditional_21_Template, 35, 15);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
        ...
        \u0275\u0275advance();
        \u0275\u0275classProp("done", ctx.selectedSeason());
        \u0275\u0275advance(2);
        \u0275\u0275classProp("complete", ctx.selectedSeason());
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" ", ctx.selectedSeason() ? "\u2705" : "1", " ");
        \u0275\u0275advance(6);
        \u0275\u0275conditional(18, ctx.selectedSeason() ? 18 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(19, !ctx.selectedSeason() ? 19 : 20);
        \u0275\u0275advance(2);
        \u0275\u0275conditional(21, ctx.selectedSeason() ? 21 : -1);
      }
    }, dependencies: [CommonModule, NgClass, FormsModule], styles: ["\n\n.admin-page[_ngcontent-%COMP%] {\n  padding: 28px 24px;\n  max-width: 720px;\n}\n.admin-page-header[_ngcontent-%COMP%] {\n  margin-bottom: 24px;\n}\n.wizard-step[_ngcontent-%COMP%] {\n  padding: 20px;\n  margin-bottom: 16px;\n}\n.wizard-step.done[_ngcontent-%COMP%] {\n  opacity: 0.8;\n}\n.step-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  gap: 14px;\n}\n.step-num[_ngcontent-%COMP%] {\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  background: rgba(212, 175, 55, 0.15);\n  border: 1px solid rgba(212, 175, 55, 0.3);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: var(--font-timer);\n  font-size: 14px;\n  font-weight: 900;\n  color: var(--gold);\n  flex-shrink: 0;\n}\n.step-num.complete[_ngcontent-%COMP%] {\n  background: rgba(0, 200, 83, 0.15);\n  border-color: rgba(0, 200, 83, 0.3);\n  color: var(--green-cricket);\n}\n.step-title[_ngcontent-%COMP%] {\n  font-family: var(--font-body);\n  font-size: 15px;\n  font-weight: 700;\n  color: #fff;\n  margin-bottom: 2px;\n}\n.season-select-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  margin-top: 4px;\n}\n.season-select-btn[_ngcontent-%COMP%] {\n  background: rgba(10, 31, 47, 0.6);\n  border: 1px solid rgba(212, 175, 55, 0.1);\n  border-radius: var(--radius-md);\n  padding: 14px 16px;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  transition: all 0.15s;\n  text-align: left;\n}\n.season-select-btn[_ngcontent-%COMP%]:hover {\n  border-color: rgba(212, 175, 55, 0.4);\n  background: rgba(30, 58, 95, 0.4);\n}\n.season-sel-name[_ngcontent-%COMP%] {\n  font-family: var(--font-body);\n  font-size: 15px;\n  font-weight: 700;\n  color: #fff;\n}\n.selected-season-display[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  margin-top: 14px;\n  padding: 12px 14px;\n  background: rgba(10, 31, 47, 0.5);\n  border-radius: var(--radius-md);\n}\n.template-info[_ngcontent-%COMP%] {\n  margin-top: 16px;\n}\n.template-card[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 14px;\n  padding: 14px 16px;\n  border-radius: var(--radius-md);\n  margin-bottom: 12px;\n}\n.template-card.fresh[_ngcontent-%COMP%] {\n  background: rgba(0, 200, 83, 0.08);\n  border: 1px solid rgba(0, 200, 83, 0.2);\n}\n.template-card.retention[_ngcontent-%COMP%] {\n  background: rgba(212, 175, 55, 0.08);\n  border: 1px solid rgba(212, 175, 55, 0.2);\n}\n.template-card.direct[_ngcontent-%COMP%] {\n  background: rgba(45, 156, 219, 0.08);\n  border: 1px solid rgba(45, 156, 219, 0.2);\n}\n.template-icon[_ngcontent-%COMP%] {\n  font-size: 28px;\n}\n.template-name[_ngcontent-%COMP%] {\n  font-family: var(--font-body);\n  font-size: 14px;\n  font-weight: 700;\n  color: #fff;\n}\n.template-sheets[_ngcontent-%COMP%] {\n  font-size: 12px;\n  color: #888;\n  margin-top: 2px;\n}\n.template-rules[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.rule-row[_ngcontent-%COMP%] {\n  font-family: var(--font-body);\n  font-size: 12px;\n  color: #888;\n}\n.upload-area[_ngcontent-%COMP%] {\n  border: 2px dashed rgba(212, 175, 55, 0.2);\n  border-radius: var(--radius-lg);\n  padding: 36px;\n  text-align: center;\n  cursor: pointer;\n  margin-top: 16px;\n  transition: all 0.15s;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 8px;\n}\n.upload-area[_ngcontent-%COMP%]:hover, .upload-area.has-file[_ngcontent-%COMP%] {\n  border-color: var(--gold);\n  background: rgba(212, 175, 55, 0.04);\n}\n.upload-filename[_ngcontent-%COMP%] {\n  font-family: var(--font-body);\n  font-size: 14px;\n  color: #ccc;\n  font-weight: 600;\n}\n.upload-result-display[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 24px;\n  margin-top: 16px;\n  flex-wrap: wrap;\n}\n.result-stat[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 4px;\n}\n.result-num[_ngcontent-%COMP%] {\n  font-family: var(--font-timer);\n  font-size: 32px;\n  font-weight: 900;\n}\n.result-errors[_ngcontent-%COMP%] {\n  margin-top: 12px;\n  background: rgba(58, 10, 10, 0.5);\n  border-radius: var(--radius-md);\n  padding: 12px;\n  max-height: 120px;\n  overflow-y: auto;\n}\n.err-line[_ngcontent-%COMP%] {\n  font-size: 12px;\n  color: #f87171;\n  padding: 2px 0;\n}\n/*# sourceMappingURL=players.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlayersAdminComponent, { className: "PlayersAdminComponent", filePath: "app\\admin\\players\\players.component.ts", lineNumber: 382 });
})();
export {
...
*/
//# sourceMappingURL=chunk-4GJBLJMZ.js.map
